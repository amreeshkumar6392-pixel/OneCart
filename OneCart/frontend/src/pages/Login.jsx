...
import { FaEnvelope, FaLock, FaShoppingBag, FaShieldAlt, FaTruck, FaTag, FaArrowRight } from "react-icons/fa";
...
function Login() {
  ...
  return (
    <div className="min-h-[100vh] w-full bg-gradient-to-l from-[#141414] to-[#0c2025] text-white flex items-center justify-center px-[15px] py-[25px] md:px-[30px] md:py-[40px]">
      ...
      {/* Main Container */}
      <div className="relative w-full max-w-[1150px] min-h-[600px] lg:min-h-[650px] grid grid-cols-1 lg:grid-cols-2 overflow-hidden rounded-[24px] border border-[#9de7f220] bg-[#07171b]/80 backdrop-blur-[15px] shadow-[0_25px_80px_#00000070]">
        ...
        <div className="relative hidden lg:flex flex-col justify-between overflow-hidden px-[50px] py-[45px] bg-gradient-to-br from-[#0c252b] via-[#091b20] to-[#050b0d]">
          ...
          <div className="relative mt-[30px]">
            ...
            <p className="text-[#91a9ae] text-[14px] leading-[1.8] max-w-[440px] mt-[20px]">
              Sign in to continue your shopping journey and discover the
              latest styles, quality products, and exclusive deals.
            </p>
        ...
        <div className="relative flex items-center justify-center p-[15px] md:p-[30px] lg:p-[40px] bg-[#061417]">
          ...
          <div className="relative w-full max-w-[520px] rounded-[20px] border border-[#9de7f225] bg-gradient-to-br from-[#0d2429] via-[#091b20] to-[#050b0d] p-[25px] md:p-[35px] shadow-[0_15px_50px_#00000050]">
            ...
            <form onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                className="w-full h-[50px] mt-[20px] rounded-[10px] bg-[#9de7f2] hover:bg-white text-[#061417] text-[14px] font-semibold flex items-center justify-center gap-[10px] cursor-pointer hover:scale-[1.01] active:scale-[0.99] transition-all duration-300"
              >
